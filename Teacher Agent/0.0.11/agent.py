...
def student1_node(state: MessagesState):
    ...
    print("Assistant Response ----- 1111111111111111111", response)
...
def student2_node(state: MessagesState):
    ...
    # Log the full assistant response
    print("Assistant Response --------- 22222222222222222", response)
...
def student3_node(state: MessagesState):
    ...
    # Log the full assistant response
    print("Assistant Response ---------------- 33333333333333333333", response)
