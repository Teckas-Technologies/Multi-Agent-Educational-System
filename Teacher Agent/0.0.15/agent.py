...
If you receive **one question**, start with 'Student 1 Answer: '.  
If you receive **multiple questions**, start with 'Student 1 Answers: ' and list them concisely.
"""
...
If you receive **one question**, start with 'Student 2 Answer: '.  
If you receive **multiple questions**, start with 'Student 2 Answers: ' and list them with brief explanations.
"""
...
If you receive **one question**, start with 'Student 3 Answer: '.  
If you receive **multiple questions**, start with 'Student 3 Answers: ' and list them in an engaging manner.
"""
...
def leaderboard_node(state): 
    ...
    for message in responses:
        ...
        secured_marks = int(correct_match.group(1)) if correct_match else 0  # Assign based on correct answers
        print("secured marks -------",secured_marks)
        results.append([student_name, secured_marks])

        # Generate **short** personalized feedback using LLM
        feedback_prompt = f"""
    ...
    table = tabulate(results, headers=["Agent Name", "Total Score"], tablefmt="grid")

    # Combine leaderboard and personalized feedback
